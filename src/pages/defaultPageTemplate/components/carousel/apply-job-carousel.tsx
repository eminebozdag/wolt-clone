...
const ApplyJobCarousel = () => {
  return (
    <div className="max-w-[1200px] flex flex-col items-center mt-[6.25rem] mx-auto mb-0 px-8 py-0 md:mt-[6rem] sm:mt-[4rem]">
      ...
      <div className="flex cmd:block cmd:w-full  mt-10 xs:mt-8 gap-6 ">
        {CARD_DATA.map((data) => (
          <Card {...data} />
        ))}
      </div>
