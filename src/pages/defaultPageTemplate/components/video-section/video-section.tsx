...
const VideoSection = () => {
  ...
  return (
    <div className="relative items-center w-full h-[46rem] pb-[90px] lg:h-[40rem] md:h-[34rem] csm:h-[34rem] xs:h-[20rem] lg:pb-0 cmd:pb-0 mt-[6rem] bg-c-white bg-[linear-gradient(#ffff_50%,#f2f3f5_50%)] ">
      <div className="max-w-[1184px] h-full my-0 mx-auto shadow-[rgba(0,0,0,0.05)_0px_0px_50px_0px]">
        <div className="flex relative h-full w-full text-start overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full my-0 mx-auto cmd:hidden pointer-events-none">
            ...
            <video
              className="relative w-full h-full object-cover top-0 z-50 
