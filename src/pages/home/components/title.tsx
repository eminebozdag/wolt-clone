...
const Title = () => {
  return (
    <div
      className={clsx(
        "max-w-[1200px] text-center text-c-font-gray",
        "pt-[60px] mobile:pt-[130px] desktopM:mx-auto"
      )}
    >
      <div className="px-[21px] mobile:px-[49px] tabletL:px-[56px] desktop:px-0">
        ...
        <p
          className={clsx(
            "max-w-[45rem] mx-auto font-normal",
            "text-sm mobile:text-base desktop:text-normal",
            "leading-6 desktop:leading-10"
          )}
        >
