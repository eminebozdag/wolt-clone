			...
			<div className="max-w-[1184px] my-0 mx-auto h-full shadow-c-md">
				<div className="flex relative h-full w-full text-start overflow-hidden">
					...
					<div className="flex w-[50%]">
						<ShadowBackground type="component" className="desktop:hidden" />
						...
						<div
							...
							<p className="font-normal leading-7 mb-10 hidden desktop:block">
								Wolt makes it incredibly easy for you to discover and get what you want. Delivered to you – quickly, reliably and affordably.
							</p>
							<Button className="flex mr-auto" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
								<div
									className={clsx(
					...
					<div className={clsx("absolute top-0 left-0 w-full h-full my-0 mx-auto pointer-events-none", "hidden desktop:block")}>
						<div
							className={clsx(
              ...
              transition transform duration-75 ease-[cubic-bezier(0.17, 0.67, 0.24, 0.99)] "
							...
							tabIndex={-1}
							src="https://consumer-static-assets.wolt.com/frontpage-assets/Wolt_Brand_Film_2020.mp4"></video>
					</div>
				</div>
			</div>
		</div>
