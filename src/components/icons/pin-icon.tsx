...
const PinIcon = ({height, width, className, ...props}: SVGProps) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width={width} height={height} viewBox="0 0 24 24" {...props} className={className}>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
