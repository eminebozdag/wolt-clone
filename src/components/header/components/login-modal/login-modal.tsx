            ...
            <div className="absolute right-4 top-4">
              ...
              >
                <CloseIcon
                  ...
                  width={17}
                  fill={"footer-c-gray"}
                  className="tabletL:h-[20px] tabletL:w-[20px]"
                />
              </Button>
            </div>
              ...
              <div className="flex flex-col justify-between">
                ...
                <div className="flex flex-col text-xs tabletL:text-sm">
                            ...
                            <div className="flex">
                              {
                                <social.Component
                                  height={14}
                                  width={14}
                                  className="tabletL:h-4 tabletL:w-4"
                                />
                              }
                            </div>
                  ...
                  <div className="flex mt-4 items-center">
                    ...
                    <span className="text-c-font-gray mx-4 text-xxs tabletL:text-xs">
                  ...
                  <span
                    className={clsx(
                      "text-c-gray-medium pt-[7px] mt-[7px]",
