...
const Button: React.FC<Props> = (props: Props) => {
	...
	const styles = {
		primary: clsx("justify-center text-sm text-c-white font-bold bg-c-blue px-[1rem] min-h-[2.875rem] rounded-lg", hover && "hover:bg-c-blue/90"),
		secondary: clsx("justify-center text-xs font-medium rounded-lg", hover && "hover:bg-c-white/20"),
