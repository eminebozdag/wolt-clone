...
const Footer = () => {
  return (
    <footer
      className={clsx(
        "bg-c-footer-gray",
        "px-4 pb-[28px] tabletL:pb-8",
        "pt-[36.750px] mobile:px-[30px] tablet:pt-[91px] tabletL:pt-[104px]"
      )}
    >
      <div className="flex flex-col max-w-[1140px] m-auto">
        ...
        >
          <div className="flex flex-col flex-[2_1_0%]">
            <WoltLogo
              ...
              height={26}
              width={72}
              className="mb-[24.5px] mobile:mb-7"
            />
        ...
        <div
          className={clsx(
            ...
            "flex-col tabletM:flex-row",
            "text-cxs tabletL:text-xxs"
          )}
        >
            ...
            {SETTINGS.map((data) => (
              <Button variant="flat">
                <div className="flex justify-center items-center h-4 w-4">
                  {<data.Component height={10} width={10} />}
                </div>
                {data.title}
              </Button>
            ))}
          ...
          <div className="flex flex-row flex-wrap justify-between items-center gap-2">
            ...
            <div className="text-c-white/75 tablet:ml-[2.5rem]">
              ©️ Wolt 2014–2023
            </div>
          </div>
        </div>
